          ...
          <div className="bg-white dark:bg-white/5 rounded-xl border border-neutral-200 dark:border-white/5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 px-5 py-5">
              <div>
                ...
                <input type="text" defaultValue="AirLink" className="rounded-xl border border-neutral-200 dark:border-neutral-600/30 focus:border-neutral-400 focus:outline-none text-sm w-full bg-neutral-100 dark:bg-neutral-700/20 px-4 py-2 text-neutral-800 dark:text-white transition-colors" />
              </div>
              <div>
          ...
          <div className="bg-white dark:bg-white/5 rounded-xl border border-neutral-200 dark:border-white/5">
            ...
            <div className="px-5 py-5 flex items-center justify-between">
              ...
              <button onClick={() => setAllowReg(!allowReg)}
                className={cn("relative inline-flex h-6 w-11 items-center rounded-full transition-colors", allowReg ? "bg-blue-600" : "bg-neutral-300 dark:bg-neutral-600")}>
                <span className={cn("inline-block h-5 w-5 transform rounded-full bg-white border border-neutral-200 transition-transform", allowReg ? "translate-x-5" : "translate-x-0.5")} />
              </button>
            </div>
          </div>
        ...
        <div className="space-y-5">
          <div className="bg-white dark:bg-white/5 rounded-xl border border-neutral-200 dark:border-white/5">
            ...
            <div className="px-5 py-5 space-y-5">
              {[
                { label: "Allow users to create servers", desc: "Users can create their own servers up to their limit.", value: allowCreate, set: setAllowCreate },
                { label: "Allow users to delete servers", desc: "Users can delete servers they own.", value: allowDelete, set: setAllowDelete },
              ].map((item) => (
                <div key={item.label} className="flex items-center justify-between">
                  ...
                  <button onClick={() => item.set(!item.value)}
                    className={cn("relative inline-flex h-5 w-10 items-center rounded-full transition-colors", item.value ? "bg-blue-600" : "bg-neutral-300 dark:bg-neutral-600")}>
                    <span className={cn("inline-block h-4 w-4 transform rounded-full bg-white border transition-transform", item.value ? "translate-x-5" : "translate-x-0.5")} />
                  </button>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white dark:bg-white/5 rounded-xl border border-neutral-200 dark:border-white/5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 px-5 py-5">
              {[
                { label: "Server limit", id: "serverLimit", default: "3", unit: "" },
                { label: "Max memory", id: "maxMemory", default: "1024", unit: "MB" },
                { label: "Max CPU", id: "maxCpu", default: "100", unit: "%" },
                { label: "Max storage", id: "maxStorage", default: "10", unit: "GB" },
              ].map((f) => (
                <div key={f.id}>
                  <label className="block text-sm font-medium text-neutral-700 dark:text-white mb-2">{f.label} {f.unit && <span className="text-neutral-400 font-normal">({f.unit})</span>}</label>
                  <input type="number" defaultValue={f.default} className="rounded-xl border border-neutral-200 dark:border-neutral-600/30 focus:border-neutral-400 focus:outline-none text-sm w-full bg-neutral-100 dark:bg-neutral-700/20 px-4 py-2 text-neutral-800 dark:text-white transition-colors" />
                </div>
              ))}
            </div>
        ...
        <div className="space-y-5">
          <div className="bg-white dark:bg-white/5 rounded-xl border border-neutral-200 dark:border-white/5">
            ...
            <div className="px-5 py-5">
              ...
              <input type="password" placeholder="Paste your key" className="rounded-xl border border-neutral-200 dark:border-neutral-600/30 focus:border-neutral-400 focus:outline-none text-sm w-full max-w-sm bg-neutral-100 dark:bg-neutral-700/20 px-4 py-2 text-neutral-800 dark:text-white placeholder-neutral-400 font-mono transition-colors" />
          ...
          <div className="bg-white dark:bg-white/5 rounded-xl border border-neutral-200 dark:border-white/5">
            <h2 className="text-[13px] font-medium text-neutral-800 dark:text-white px-5 py-3.5 bg-neutral-50 dark:bg-white/5 rounded-t-xl border-b border-neutral-200 dark:border-white/5">Rate limiting</h2>
            <div className="px-5 py-5 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setRateLimit(!rateLimit)}
                  className={cn("relative inline-flex h-6 w-11 items-center rounded-full transition-colors", rateLimit ? "bg-blue-600" : "bg-neutral-300 dark:bg-neutral-600")}>
                  <span className={cn("inline-block h-5 w-5 transform rounded-full bg-white border transition-transform", rateLimit ? "translate-x-5" : "translate-x-0.5")} />
                </button>
              </div>
              <div>
                <label className="block text-sm font-medium text-neutral-700 dark:text-white mb-2">Requests per minute</label>
                <input type="number" defaultValue="100" className="rounded-xl border border-neutral-200 dark:border-neutral-600/30 focus:border-neutral-400 focus:outline-none text-sm w-48 bg-neutral-100 dark:bg-neutral-700/20 px-4 py-2 text-neutral-800 dark:text-white transition-colors" />
              </div>
            </div>
          </div>
        </div>
