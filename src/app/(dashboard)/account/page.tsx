...
const mockUser = { id: 1, username: "admin", email: "admin@example.com", description: "Administrator", avatar: "", lang: "en" };
...
export default function AccountPage() {
  const [lang, setLang] = useState(mockUser.lang);
  const avatarUrl = mockUser.avatar || `https://api.dicebear.com/9.x/thumbs/svg?seed=${mockUser.username}`;

  return (
    <>
      <div className="flex items-center gap-4 mb-5">
        <div className="relative shrink-0">
          <img id="avatar-preview" src={avatarUrl} alt="Avatar" className="h-12 w-12 rounded-xl border border-neutral-200 dark:border-white/10 object-cover" />
          ...
          <div className="grid grid-cols-2 gap-x-5 gap-y-4">
            ...
            <div>
              ...
              <div className="flex gap-1.5">
                <input type="text" defaultValue={mockUser.username} className="rounded-lg border border-neutral-200 dark:border-neutral-600/30 focus:border-neutral-400 focus:outline-none text-xs w-full bg-white dark:bg-neutral-700/20 px-3 py-1.5 text-neutral-800 dark:text-white placeholder-neutral-400 transition-colors" />
            ...
            <div>
              ...
              <div className="flex gap-1.5">
                <input type="email" defaultValue={mockUser.email} className="rounded-lg border border-neutral-200 dark:border-neutral-600/30 focus:border-neutral-400 focus:outline-none text-xs w-full bg-white dark:bg-neutral-700/20 px-3 py-1.5 text-neutral-800 dark:text-white placeholder-neutral-400 transition-colors" />
                <Button size="sm" className="shrink-0 text-xs h-7">Save</Button>
              </div>
            </div>
            ...
            <div>
              ...
              <select value={lang} onChange={(e) => setLang(e.target.value)} className="rounded-lg border border-neutral-200 dark:border-neutral-600/30 focus:border-neutral-400 focus:outline-none text-xs w-full bg-white dark:bg-neutral-700/20 px-3 py-1.5 text-neutral-800 dark:text-white transition-colors mb-1.5">
